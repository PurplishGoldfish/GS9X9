...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname GS9X9_1.0.1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
; Updates:
; - You can fly like flappy bird
; - You are controlled using arrow keys
...
(define (key-handler a k)
  (cond [(key=? k "1") (make-game (game-x a) 10 (game-x_velocity a) (game-y_velocity a) 0 (game-falling? a))]
        ...
        [(key=? k "left") (make-game (game-x a) (game-y a) (- (game-x_velocity a) 1) (game-y_velocity a) (game-falling_time a) (game-falling? a))]
        [(key=? k "right") (make-game (game-x a) (game-y a) (+ (game-x_velocity a) 1) (game-y_velocity a) (game-falling_time a) (game-falling? a))]
