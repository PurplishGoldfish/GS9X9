...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname GS9X9_1.0.2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
; Updates:
; - Game is faster.
; - You are a plastic brick.
; - The floor is made of wood, so you slide better. The old one was concrete.
; - You can also move faster now.
